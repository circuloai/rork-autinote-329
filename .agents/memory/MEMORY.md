...
- [Expo Notifications entitlements](expo-notifications-entitlements.md) — keep Expo’s standard APNs entitlement; user plugins cannot reliably strip the final auto-plugin result.
